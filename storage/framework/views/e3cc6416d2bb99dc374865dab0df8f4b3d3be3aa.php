               ...
               <div class="container">
                  <div class="row">
                     ...
                     <div class="col-md-9 col-lg-9 col-sm-12 col-xs-12">
                        <div class="panel-heading overflow-h">
                           <h2 class="panel-title heading-sm pull-left">Congrats your Booking has confirmed             </h2>
                        </div>
                  ...
                  <div class="ex">
                     <button class="btn-u btn-u-dark" type="button">Print/AddReminder</button>
                  </div>
               </div>
