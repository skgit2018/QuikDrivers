   ...
   <html lang="en" class="ie9">
      ...
      <html lang="en">
         ...
         <body>
               ...
               <div class="slider-inner">
                  <div id="da-slider" class="da-slider">
                     ...
                     <div class="da-slide">
                        <h2><i>PLEASE &amp;</i> <br /> <i>SIGN UP HERE</i> </h2>
                        <div class="da-img">
                           <img class="img-responsive" src="assets/plugins/parallax-slider/img/car5.png" alt="">
                        </div>
                     </div>
                     <div class="da-slide">
                        <h2><i>PLEASE &amp;</i> <br /> <i>SIGN UP HERE</i> </h2>
                        <div class="da-img"><img src="assets/plugins/parallax-slider/img/car1.png" alt="image01" /></div>
                     </div>
                     <div class="da-arrows">
               ...
               <div class="container content">
                  <div class="row margin-bottom-40">
                     <div class="col-md-6 md-margin-bottom-40">
                        ...
                        <br />
                        <!-- Blockquotes -->
                        <button class="btn-u btn-u-Green" type="button">Read More</button>
                     </div>
                     <div class="col-md-6 md-margin-bottom-40">
                        <div class="responsive-image">
                           <img src="assets/img/breadcrumbs/img4.png">
                        </div>
                     </div>
                  </div>
                  <!--/row-->
            ...
            <ul class="phones">
            <li> <img src="assets/img/cooming/playstore.png"></li>
            <li class="onr"><img src="assets/img/cooming/ios.png"></li>
            </ul>
            </div>
            <div class="col-md-6">
            <img class="img-responsive" src="assets/img/cooming/phone.png" alt="">
            </div>
            </div>
            </div>
            </div>  
