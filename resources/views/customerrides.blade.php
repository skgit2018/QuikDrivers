                     ...
                     <div class="row">
                        ...
                        <div class="col-md-9">
                           <div class="profile-body">
                              ...
                              <div class="panel-heading overflow-h">
                                 <h2 class="panel-title heading-sm pull-left">Upcoming Bookings</h2>
                                 <a href="#"></a>
                              </div>
                                    ...
                                    <table class="table table-hover table-bordered table-striped">
                                       ...
                                       <tbody>
                                          <tr>
                                             ...
                                             <td>500</td>
                                             <td>Cash</td>
                                             <td><button class="btn btn-success btn-xs">Cancel</button></td>
                                             <td><button class="btn btn-danger btn-xs">Reschedule</button></td>
                                          </tr>
                                          <tr>
                                             <td>Dec/24/2018</td>
                                             <td> 10:00 - 14:00</td>
                                             ...
                                             <td><button class="btn btn-success btn-xs">Reschedule</button></td>
                                          </tr>
                                          <tr>
                                             <td>Dec/24/2018</td>
                                             <td> 10:00 - 14:00</td>
                        ...
                        <div class="col-md-9">
                           <div class="profile-body">
                              <!--Table Search v1-->
                              <div class="panel-heading overflow-h">
                                 <h2 class="panel-title heading-sm pull-left">Request Bookings</h2>
                                 <a href="#"></a>
                              </div>
                              <div class="table-search-v1 margin-bottom-20">
                                 <div class="table-responsive">
                              ...
                              <div class="panel panel-profile">
                                 <div class="panel-heading overflow-h">
                                    <a href="#collapse-Seven" data-parent="#accordion-v1" data-toggle="collapse" class="accordion-toggle">
                                       <h2 class="panel-title heading-sm pull-left">Announcements</h2>
                                          ...
                                          <table class="table table-hover table-bordered table-striped">
                                             ...
                                             <tbody>
                                                <tr>
                                                   ...
                                                   <td><button class="btn btn-success btn-xs">More details
                                                      </button>
                                                   </td>
                                                </tr>
                                             </tbody>
